<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:40:"./themes/default/index/score_detail.html";i:1504836733;}*/ ?>
<!DOCTYPE html PUBLIC "-//WAPFORUM//DTD XHTML Mobile 1.0//EN" "http://www.wapforum.org/DTD/xhtml-mobile10.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" name="viewport">
<title><?php echo $tyjfmc; ?>明细</title>
...
<body><div class="yingdao" align="center">
  <p><b><?php echo $tyjfmc; ?>明细</b><a href="javascript:;" onclick="history.back()" title="返回" class="left"></a> <a href="<?php echo url('user/usercenter'); ?>"  title="会员中心" class="right"></a> </p></div>  
...
<li style="padding: 10px;margin-top:5px;border-top: none;overflow: hidden; line-height: 1.6em;border-bottom: 1px dashed #DED6C9;"> 
  <span style="display: block;overflow: hidden;clear: both;padding: .22em 0;"><span><?php echo $data['info']; ?>：<?php switch($data['type']): case "1": ?>+<?php echo $data['score']; break; case "2": ?>+<?php echo $data['score']; break; default: ?>
            -<?php echo $data['score']; endswitch; ?><span style="float: right;"><?php echo $data['nickname']; ?></span></span>
  <span class="pricecolor" style="display: block;margin-top:10px; margin-bottom:5px;color:#ff3366"><?php echo date('Y-m-d H:i:s',$data['addtime']); ?><span style="float: right;"><?php 
        if($data['mobile']){
