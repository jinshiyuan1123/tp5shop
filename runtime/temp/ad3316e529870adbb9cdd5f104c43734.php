<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:81:"D:\phpStudy2018\PHPTutorial\WWW\tp5/application/admin\view\member\withdrawal.html";i:1524903174;s:75:"D:\phpStudy2018\PHPTutorial\WWW\tp5/application/admin\view\common\head.html";i:1525738497;s:77:"D:\phpStudy2018\PHPTutorial\WWW\tp5/application/admin\view\common\header.html";i:1501063294;s:77:"D:\phpStudy2018\PHPTutorial\WWW\tp5/application/admin\view\common\navbar.html";i:1477622211;s:77:"D:\phpStudy2018\PHPTutorial\WWW\tp5/application/admin\view\common\footer.html";i:1501054036;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <!--  <td class="mailbox-name" name="id" id="id"><?php echo $list['id']; ?></td> -->
                    ...
                    <td><?php echo $list['zsname']; ?></td>

                      <td><?php echo $list['weixinhao']; ?></td>
                      <td><?php echo $list['zhifubao']; ?></td>
                    <td><?php echo $list['amount']; ?></td>
                    <td><?php echo $list['true_amount']; ?></td>
                    <td><?php echo time_format($list['addtime']); ?></td>
                    <td><?php switch($list['status']): case "1": ?><span class="label label-success">成功</span><?php break; case "0": ?><span class="label label-danger">等待提现</span><?php break; default: ?><span class="label label-danger">已取消</span>
                    <?php endswitch; ?></td>
                  </tr>
                  <?php endforeach; endif; else: echo "" ;endif; ?>
  ...
  $('document').ready(function(argument){
    ...
    $('.setStatusSubmit').click(function(){
      ...
      $.ajax({
        cache:true,
        type :"POST",
        url  :'<?php echo url('withdrawal_setStatus'); ?>',
    ...
    $('.search').keyup(function (event) {
      if (event.keyCode == "13") {
          getUrl = '<?php echo url('withdrawal',['q'=>'qstring']); ?>';
          location.href = getUrl.replace("qstring", $('.search').val());
      }
    });
     //筛选方法
     $('.filter').click(function(event){
          getUrl  = '<?php echo url('withdrawal',['status'=>'filterStatus']); ?>';
