<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\goods\goodsedit.html";i:1524646478;s:71:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\common\header.html";i:1501063294;s:71:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\common\navbar.html";i:1477622210;s:71:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\common\footer.html";i:1501054036;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <div class="box-body">
              ...
              <div class="form-extend">
                ...
                <div class="form-group">
                  <label>所属分类</label>
                  <br/>
                  <label><input name="categoryIds" <?php if($goodsInfo['categoryIds'] == '1'): ?> checked="checked" <?php endif; ?> type="radio" value="1" />普通商品 </label> 
                  <label><input name="categoryIds" <?php if($goodsInfo['categoryIds'] == '2'): ?> checked="checked" <?php endif; ?> type="radio" value="2" />公排商品 </label>
              </div>
              </div>
            </div>
            <!-- /.box-body -->
