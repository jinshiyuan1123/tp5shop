<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:84:"D:\phpStudy2018\PHPTutorial\WWW\tp5/application/admin\view\member\gongpai_xinxi.html";i:1524748255;s:75:"D:\phpStudy2018\PHPTutorial\WWW\tp5/application/admin\view\common\head.html";i:1525738497;s:77:"D:\phpStudy2018\PHPTutorial\WWW\tp5/application/admin\view\common\header.html";i:1501063294;s:77:"D:\phpStudy2018\PHPTutorial\WWW\tp5/application/admin\view\common\navbar.html";i:1477622211;s:77:"D:\phpStudy2018\PHPTutorial\WWW\tp5/application/admin\view\common\footer.html";i:1501054036;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td><a ><?php echo $list['id']; ?></a></td>
                    <td><a ><?php echo $list['mobile']; ?></a></td>
                    <td><a ><?php echo $list['nickname']; ?></a></td>
                      <td><a ><?php echo $list['zsname']; ?></a></td>
                      <td><a >   
                        <?php switch($list['jibie']): case "0": ?>D层<?php break; case "1": ?>C层<?php break; case "2": ?>B层<?php break; case "3": ?>A层<?php break; case "4": ?>队长<?php break; endswitch; ?>第<?php echo $list['bcsx']; ?>位置
                      </a></td>
                    <td><a ><?php echo $list['money']; ?></a></td>
...
<script type="text/javascript">
  $('document').ready(function(argument){
    ...
    $('.search').keyup(function (event) {
      if (event.keyCode == "13") {
          getUrl = '<?php echo url('gongpai_xinxi',['q'=>'qstring']); ?>';
          location.href = getUrl.replace("qstring", $('.search').val());
      }
    });
     //筛选方法
     $('.filter').click(function(event){
          getUrl  = '<?php echo url('gongpai_xinxi',['status'=>'filterStatus']); ?>';
          getUrl = getUrl.replace("filterStatus", $('.filterStatus').val());
          location.href = getUrl;
     }); 
     //筛选方法
     $('.filter1').click(function(event){
          getUrl  = '<?php echo url('gongpai_xinxi',['ksjf'=>'ksjff','jzjf'=>'jzjff']); ?>';
