<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:69:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\order\index.html";i:1501926366;s:69:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\common\head.html";i:1525738497;s:71:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\common\header.html";i:1501063294;s:71:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\common\navbar.html";i:1477622210;s:71:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\common\footer.html";i:1501054036;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <td><a href="<?php echo url('order/detail',['id'=>$list['order_no']]); ?>"><?php echo date("Y-m-d H:i:s",$list['createtime']); ?></a></td>
                    <td><?php switch($list['status']): case "paid": ?><span class="label label-success">已支付</span><?php break; case "shipped": ?><span class="label label-success">已发货</span><?php break; case "completed": ?><span class="label label-success">已完成</span><?php break; case "cancel": ?><span class="label label-primary">用户取消</span><?php break; case "delete": ?><span class="label label-warning">用户删除</span><?php break; endswitch; ?></td>
