<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:70:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\member\score.html";i:1501926398;s:69:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\common\head.html";i:1525738497;s:71:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\common\header.html";i:1501063294;s:71:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\common\navbar.html";i:1477622210;s:71:"Z:\wwwroot\zsh.ruishengkj.net/application/admin\view\common\footer.html";i:1501054036;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <li class="active"><a href="#activity" data-toggle="tab">增减积分</a></li>
            ...
            <div class="tab-pane active" id="activity">
              <!-- Font Awesome Icons -->
              <form   method="post" action=<?php echo url('score'); ?> id="editpost">
              <div class="box-body">
              <div class="form-group">
                  <label for="exampleInputPassword1">手机号</label>
                  <input type="text" class="form-control" readOnly="true" value="<?php echo $usersInfo['mobile']; ?>"  />
                </div>
              <div class="form-group">
                  <label for="exampleInputPassword1">当前积分</label>
                  <input type="text" class="form-control" readOnly="true" value="<?php echo $usersInfo['score']; ?>"  />
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">增减值</label>
                  <input type="text" class="form-control" id="score" value="" name="score" />
                  增加积分直接填入值如：100.01；减少积分填入负值如：-100.01；
                </div>
